 ...
 */
final class Version20221020072137 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE admin_login (uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary_ordered_time)\', adminIp VARCHAR(50) NOT NULL, country VARCHAR(50) NOT NULL, continent VARCHAR(50) NOT NULL, organization VARCHAR(50) NOT NULL, deviceType VARCHAR(20) NOT NULL, deviceBrand VARCHAR(20) NOT NULL, deviceModel VARCHAR(40) NOT NULL, isMobile ENUM(\'yes\', \'no\'), osName VARCHAR(20) NOT NULL, osVersion VARCHAR(20) NOT NULL, osPlatform VARCHAR(20) NOT NULL, clientType VARCHAR(20) NOT NULL, clientName VARCHAR(40) NOT NULL, clientEngine VARCHAR(20) NOT NULL, clientVersion VARCHAR(20) NOT NULL, loginStatus ENUM(\'success\', \'fail\'), identity VARCHAR(100) NOT NULL, created DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_A2230EA37B3BD4C (adminIp), UNIQUE INDEX UNIQ_A2230EA6A95E9C4 (identity), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
